...
export class Iframe {
    ...
    constructor(options: IframeOptions) {
        ...
        this.iframe = this.createIframe(sandboxAttributes);
    ...
    private createIframe = (sandboxAttributes?: string[]) => {
        ...
        if (sandboxAttributes?.length) {
            iframe.sandbox.add(sandboxAttributes.join(', '));
        }
